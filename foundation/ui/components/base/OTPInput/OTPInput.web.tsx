...
/**
 * @component OTPInput (Web)
 * @description An auto-advancing, multi-cell verification code input for web.
 */
const OTPInputWeb: React.FC<OTPInputProps> = (rawProps) => {
