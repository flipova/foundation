...
export interface DeckLayoutProps extends ExtractLayoutProps<"DeckLayout"> {
...
const PeekCard = ({
  ...
  swipeProgress: ReturnType<typeof useSharedValue<number>>; cardBackground: string; cardBorderRadius: any;
}) => {
