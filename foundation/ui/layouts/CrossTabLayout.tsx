...
export interface CrossTabLayoutProps extends ExtractLayoutProps<"CrossTabLayout"> {
...
const CrossTabLayout: React.FC<CrossTabLayoutProps> = (rawProps) => {
    ...
    const gap = useMemo(() => spacingTokens[spacing as keyof typeof spacingTokens] ?? 0, [spacing]);
