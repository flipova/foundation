...
const s = StyleSheet.create({
  ...
  stepHeader: { flexDirection: 'row', alignItems: 'center', gap: 8, paddingHorizontal: 10, paddingVertical: 8, borderBottomWidth: 1, borderBottomColor: C.border },
  stepNum: { width: 20, height: 20, borderRadius: 10, backgroundColor: C.surface2, alignItems: 'center', justifyContent: 'center', flexShrink: 0 },
  stepNumTxt: { color: C.muted, fontSize: 9, fontWeight: '700' },
  opScroll: { gap: 4 },
  opBtn: { paddingHorizontal: 8, paddingVertical: 4, borderRadius: 4, backgroundColor: C.surface2, borderWidth: 1, borderColor: C.border },
  opBtnOn: { backgroundColor: C.primary, borderColor: C.primary },
  opBtnTxt: { color: C.muted, fontSize: 10, fontWeight: '500' },
  ...
  stepArgs: { padding: 10, gap: 8 },
  argRow: { gap: 4 },
  argLabel: { color: C.muted, fontSize: 9, fontWeight: '600', textTransform: 'uppercase' as any, letterSpacing: 0.5 },
  argInput: { height: 28, backgroundColor: C.surface2, borderRadius: 5, borderWidth: 1, borderColor: C.border, color: C.text, fontSize: 11, paddingHorizontal: 10 },
