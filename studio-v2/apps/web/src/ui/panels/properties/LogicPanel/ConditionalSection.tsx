        ...
        <View style={s.modeRow}>
          ...
          >
            ...
            <View>
              ...
              <Text style={[s.modeBtnSub, mode === 'show' && { color: C.textSub }]}>when condition is met</Text>
            </View>
          </Pressable>
          <Pressable
          ...
          >
            ...
            <View>
              ...
              <Text style={[s.modeBtnSub, mode === 'hide' && { color: C.textSub }]}>when condition is met</Text>
            </View>
          </Pressable>
        </View>
      </View>
        ...
        <View style={s.testerSection}>
          ...
          {showTester && (
            <View style={s.tester}>
              ...
              />
              {testResult !== null && (
                <View style={[s.testerResult, { backgroundColor: elementVisible ? C.surface2 : C.surface2, borderColor: elementVisible ? C.border : C.border }]}>
...
const s = StyleSheet.create({
  root: { gap: 10 },
  // Explainer
  explainer: { flexDirection: 'row', alignItems: 'flex-start', gap: 6, backgroundColor: C.surface2, borderRadius: 6, padding: 8, borderWidth: 1, borderColor: C.surface2 },
  ...
  modeBtnShow: { backgroundColor: C.surface2, borderColor: C.success },
  modeBtnHide: { backgroundColor: C.surface2, borderColor: C.error },
  ...
  // Summary
  summaryBox: { backgroundColor: C.surface2, borderRadius: 6, borderWidth: 1, borderColor: C.border, padding: 8, gap: 4 },
  ...
  tester: { backgroundColor: C.surface2, borderRadius: 6, borderWidth: 1, borderColor: C.surface2, padding: 10, gap: 8 },
