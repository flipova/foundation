    ...
    <View style={s.miniRow}>
      ...
      {expanded && (
        <View style={s.miniBody}>
          {React.createElement(require('./ActionEditor').default, { action, onChange, onRemove, itemFields })}
        </View>
      )}
    </View>
  );
...
const Lane: React.FC<{
  ...
  return (
    <View style={[s.lane, { borderTopColor: color }]}>
      ...
      {lane.map((a, ai) => 
        React.createElement(require('./ActionEditor').default, {
          key: ai,
          action: a,
          onChange: (u: ActionDef) => updateAction(ai, u),
...
const s = StyleSheet.create({
  ...
  joinHeader: { flexDirection: 'row', alignItems: 'center', gap: 8, paddingHorizontal: 12, paddingVertical: 10, backgroundColor: C.surface2, borderRadius: 8, borderWidth: 1, borderColor: '#8b5cf6' + '40' },
  joinIconBox: { width: 24, height: 24, borderRadius: 6, alignItems: 'center', justifyContent: 'center', backgroundColor: '#8b5cf6' + '20' },
  joinTitle: { flex: 1, color: C.text, fontSize: 12, fontWeight: '600' },
  joinMode: { color: '#8b5cf6', fontSize: 10, fontWeight: '700', letterSpacing: 0.8 },
  joinBody: { backgroundColor: C.bg, borderRadius: 8, borderWidth: 1, borderColor: '#8b5cf6' + '30', padding: 12, gap: 10, marginTop: 4 },
  joinLabel: { color: C.muted, fontSize: 11, fontWeight: '500' },
  joinHint: { color: C.muted, fontSize: 10, fontStyle: 'italic', marginTop: -4 },
  joinModes: { flexDirection: 'row', gap: 6 },
  joinModeBtn: { flexDirection: 'row', alignItems: 'center', gap: 6, paddingHorizontal: 10, paddingVertical: 6, borderRadius: 6, backgroundColor: C.surface2, borderWidth: 1, borderColor: C.border },
  joinModeBtnOn: { backgroundColor: '#8b5cf6', borderColor: '#8b5cf6' },
  joinModeTxt: { color: C.muted, fontSize: 10, fontWeight: '600' },
  joinRow: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  joinInput: { flex: 1, height: 28, backgroundColor: C.surface2, borderRadius: 5, borderWidth: 1, borderColor: C.border, color: C.text, fontSize: 11, paddingHorizontal: 10 },
  joinSection: { gap: 4 },
  ...
  miniRow: { backgroundColor: C.surface2, borderRadius: 6, borderWidth: 1, borderColor: C.border, overflow: 'hidden' },
  miniHeader: { flexDirection: 'row', alignItems: 'center', gap: 6, paddingHorizontal: 8, paddingVertical: 6, borderLeftWidth: 2 },
  miniIcon: { width: 18, height: 18, borderRadius: 4, alignItems: 'center', justifyContent: 'center' },
