...
import {  PageState  } from '@flipova/studio-core';
...
const s = StyleSheet.create({
  ...
  aliasRow: { borderColor: C.border, backgroundColor: C.surface2 },
  ...
  addBox: { backgroundColor: C.surface2, borderRadius: 8, borderWidth: 1, borderColor: C.surface2, padding: 10, gap: 6 },
