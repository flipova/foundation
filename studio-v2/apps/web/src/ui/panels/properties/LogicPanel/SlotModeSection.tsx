...
const s = StyleSheet.create({
  ...
  activeBadge: { backgroundColor: C.surface2, paddingHorizontal: 5, paddingVertical: 1, borderRadius: 4 },
  ...
  modeBtn: {
    ...
    borderRadius: 7, borderWidth: 1, borderColor: C.bg,
  ...
  staticHint: { flexDirection: 'row', alignItems: 'flex-start', gap: 5, padding: 6, backgroundColor: C.border, borderRadius: 6 },
  staticHintText: { color: '#6a7494', fontSize: 9, flex: 1, lineHeight: 13 },
  bindingForm: { gap: 7 },
  templateNote: { flexDirection: 'row', alignItems: 'flex-start', gap: 5, backgroundColor: C.surface2, borderRadius: 6, padding: 7, borderWidth: 1, borderColor: C.surface2 },
  templateNoteText: { color: '#22d3ee', fontSize: 9, flex: 1, lineHeight: 13 },
  dataNote: { flexDirection: 'row', alignItems: 'flex-start', gap: 5, backgroundColor: C.surface2, borderRadius: 6, padding: 7, borderWidth: 1, borderColor: C.surface2 },
  dataNoteText: { color: '#a78bfa', fontSize: 9, flex: 1, lineHeight: 13 },
  warningRow: { flexDirection: 'row', alignItems: 'center', gap: 5, backgroundColor: C.surface2, borderRadius: 5, padding: 6 },
