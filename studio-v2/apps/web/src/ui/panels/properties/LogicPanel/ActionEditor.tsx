...
import {  ActionDef  } from '@flipova/studio-core';
...
const s = StyleSheet.create({
  card: { backgroundColor: C.surface2, borderRadius: 8, borderWidth: 1, borderColor: C.border, marginBottom: 8, overflow: 'hidden' },
  head: { flexDirection: 'row', alignItems: 'center', gap: 8, paddingHorizontal: 10, paddingVertical: 8, borderBottomWidth: 1, borderBottomColor: C.border },
  iconBox: { width: 24, height: 24, borderRadius: 6, alignItems: 'center', justifyContent: 'center', flexShrink: 0 },
  ...
  removeBtn: { padding: 3 },
  // Type picker modal
  modalOverlay: { flex: 1, backgroundColor: C.bg, justifyContent: 'center', alignItems: 'center', padding: 20 },
  ...
  typeBtnTxt: { color: C.muted, fontSize: 11, fontWeight: '500' },
  fields: { padding: 10 },
  group: { gap: 8 },
  ...
  chipTxt: { color: C.muted, fontSize: 10, fontWeight: '500' },
  chipTxtOn: { color: '#fff' },
  codeInput: { backgroundColor: C.bg, borderRadius: 6, borderWidth: 1, borderColor: C.border, color: '#22c55e', fontSize: 11, fontFamily: 'monospace' as any, padding: 10, minHeight: 70, textAlignVertical: 'top' },
  // Query selector
  ...
  qRowOn: { borderColor: C_primary, backgroundColor: C.surface2 },
  ...
  // Sub-sections
  sub: { backgroundColor: C.surface2, borderRadius: 6, borderWidth: 1, borderColor: C.border, padding: 10, gap: 6 },
  subTitle: { color: C.text, fontSize: 11, fontWeight: '600' },
  // Body row
  ...
  addChip: { paddingHorizontal: 7, paddingVertical: 3, borderRadius: 4, backgroundColor: C.surface2, borderWidth: 1, borderColor: C.border },
  ...
  parallelLane: { width: 140, backgroundColor: C.bg, borderRadius: 8, borderWidth: 1, borderColor: C.border, borderTopWidth: 2, padding: 8, gap: 6 },
  parallelLaneHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 4 },
  parallelLaneLabel: { fontSize: 10, fontWeight: '700', letterSpacing: 0.5 },
  parallelAction: { flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: C.surface2, borderRadius: 5, borderLeftWidth: 2, paddingHorizontal: 8, paddingVertical: 6 },
  parallelActionIcon: { width: 18, height: 18, borderRadius: 4, alignItems: 'center', justifyContent: 'center' },
