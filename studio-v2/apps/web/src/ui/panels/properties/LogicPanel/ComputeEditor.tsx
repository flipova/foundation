...
const s = StyleSheet.create({
  ...
  descInput: { height: 28, backgroundColor: C.bg, borderRadius: 5, borderWidth: 1, borderColor: C.border, color: C.muted, fontSize: 11, paddingHorizontal: 10, fontStyle: 'italic' },
  exprInput: { backgroundColor: C.bg, borderRadius: 6, borderWidth: 1, borderColor: C.border, color: '#22c55e', fontSize: 12, fontFamily: 'monospace' as any, padding: 10, minHeight: 60, textAlignVertical: 'top' },
  snippets: { gap: 6 },
  snippet: { paddingHorizontal: 10, paddingVertical: 5, borderRadius: 5, backgroundColor: C.surface2, borderWidth: 1, borderColor: C.border },
  snippetTxt: { color: C.muted, fontSize: 10, fontWeight: '500' },
