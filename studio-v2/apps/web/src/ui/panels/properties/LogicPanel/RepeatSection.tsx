...
const s = StyleSheet.create({
  root: { gap: 8 },
  fieldsBox: { backgroundColor: C.surface2, borderRadius: 8, borderWidth: 1, borderColor: C.border, padding: 10, gap: 6 },
  ...
  fieldsList: { gap: 4 },
  fieldChip: { flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: C.surface2, borderRadius: 5, paddingHorizontal: 8, paddingVertical: 4 },
