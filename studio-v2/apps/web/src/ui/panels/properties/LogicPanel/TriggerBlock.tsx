...
const s = StyleSheet.create({
  ...
  // Add menu
  addNode: { marginHorizontal: 8, flexDirection: 'row', alignItems: 'center', gap: 8, paddingHorizontal: 10, paddingVertical: 8, borderRadius: 8, borderWidth: 1, borderStyle: 'dashed' as any, borderColor: C.primaryGlow, backgroundColor: C.primaryGlow },
  addNodeIcon: { width: 24, height: 24, borderRadius: 6, alignItems: 'center', justifyContent: 'center', backgroundColor: C.primaryGlow },
